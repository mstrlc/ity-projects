...
\usepackage[a4paper, left=1.6cm, top=1.5cm, text={18cm, 24.7cm}]{geometry}
...
\begin{quotation}
    ...
    {\color{red}tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} vypadat.
...
\footnotetext{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{\texttt{http://petr.olsak.net/ftp/olsak/vlna/}}}
